...
def stitch(specific_args, tcr_info, functionality, partial_info, codon_dict, j_warning_threshold, preferences, restriction, ref_chain):
    """
    ...
    if restriction == True:
        ...
        print(ref_chain)
        while True:
            given = input("Please enter enzymes for this TR beyond (BamHI, SalI): ")
            if not given:
                break
